...
class Latest_Offers extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            Container(
              height: 200,
              child: Image.asset('lib/src/img/Componente6.png'),
            ),
            Column(
              children: [
                Container(
            ...
            Container(
              height: 200,
              child: Image.asset('lib/src/img/Componente7.png'),
            ),
            Column(
              children: [
                Container(
            ...
            Container(
              height: 200,
              child: Image.asset('lib/src/img/Componente8.png'),
            ),
            Column(
              children: [
                Container(
